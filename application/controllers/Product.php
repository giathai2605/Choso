	...
	function displayprice() {
		...
		if($post){ 
			...
			if (isset($_POST['variationSelectedPrice']) && isset($_POST['product_regular_price']) && isset($_POST['product_sale_price']) )
			{
				...
				$variationSelectedPrice= $_POST['variationSelectedPrice'];
				$product_regular_price=$_POST['product_regular_price'];
				$product_sale_price=$_POST['product_sale_price'];

				$product_regular_price_new = 
				($variationSelectedPrice + $product_regular_price) ;

				$product_sale_price_new = 
				($variationSelectedPrice + $product_sale_price) ;
