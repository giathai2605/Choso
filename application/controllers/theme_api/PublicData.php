...
class PublicData extends MY_Controller {
	...
	public function get_classified_home_page() 
	{
		...
		$data['theme_sections']['classified_banner_title'] = isset($store_setting['classified_banner_title']) && !empty($store_setting['classified_banner_title']) ? $store_setting['classified_banner_title'] : "Explore Places in Suburb";

		$data['theme_sections']['classified_banner_subtitle'] = isset($store_setting['classified_banner_subtitle']) && !empty($store_setting['classified_banner_subtitle']) ? $store_setting['classified_banner_subtitle'] : "Keep choose best";
