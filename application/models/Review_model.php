...
class Review_model extends MY_Model{
    ...
    public function exportReviewXMLData($userdetails)
    {
        ...
        if($structure_only == 1) 
        {
            ...
            $dom->save(APPPATH.'/core/excel/output/export_admin_product_reviews_structure.xml');
            $json['download'] = base_url('application/core/excel/output/export_admin_product_reviews_structure.xml');
        ...
        else
        {
            ...
            $dom->appendChild($root);
            $dom->save(APPPATH.'/core/excel/output/export_admin_product_reviews.xml');
            $json['download'] = base_url('application/core/excel/output/export_admin_product_reviews.xml');    
        }
