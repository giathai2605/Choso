        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="nav nav-pills nav-stacked" role="tablist" id="TabsNav">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#countries" role="tab">
                        <?= __('admin.countries') ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#states" role="tab">
                        <?= __('admin.states') ?></a>
                    </li>
                </ul>
                <hr/>
            ...
            <div class="col-sm-12">
                <div class="tab-content">
                    <div class="tab-pane active" id="countries" role="tabpanel">
                        <div class="row">
                            <div class="col">
                                <button type="button" class="btn btn-success createCountryFormModal">
                ...
                <div class="tab-pane" id="states" role="tabpanel">
                    <div class="row">
                        <div class="col">
                            <button type="button" class="btn btn-success createStateFormModal">
