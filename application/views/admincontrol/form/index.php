					...
					<div role="tabpanel">
						<ul class="nav nav-pills orange-color-bg" role="tablist" id="TabsNav">
							<li role="presentation" class="active nav-item">
								<a class="nav-link active show" href="#form_tab" aria-controls="form_tab" role="tab" data-toggle="tab"><?= __('admin.form') ?></a>
							</li>
							<li role="presentation" class="nav-item">
								<a class="nav-link" href="#form_coupons_tab" aria-controls="form_coupons_tab" role="tab" data-toggle="tab"><?= __('admin.form_coupon') ?></a>
							</li>
						</ul>
