  ...
  <div class="scroll-bar d-block sidebar">
    ...
    <div class="mobile-display">
        <div class="theme-setting-wrapper">
           ...
           <i class="admin_theme_selected" id="admin_theme_selected" style="cursor: pointer;color: white;font-size: 35px;width:50px" onclick="change_admin_theme();" id="admin_theme_action"></i> 
