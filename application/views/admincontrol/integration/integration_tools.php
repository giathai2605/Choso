<style type="text/css">
	...
	<div class="col-12 mb-4">
		<div class="row intigration-page ingration-col-3">
	<div class="col-sm-3">
		<div class="card m-b-30 intigration-page-bg1 ">
			<div class="card-body">
	...
	<div class="col-sm-3">
		<div class="card m-b-30 intigration-page-bg2">
			<div class="card-body">
				<blockquote class="card-bodyquote mb-0">
	...
	<div class="col-sm-3">
		<div class="card m-b-30 intigration-page-bg3">
			<div class="card-body">
				<blockquote class="card-bodyquote mb-0">
	...
	<div class="col-sm-3">
		<div class="card m-b-30 intigration-page-bg4">
			<div class="card-body">
				<blockquote class="card-bodyquote mb-0">
		...
		<div class="card m-b-20">
			<div class="card-body">
				<div class="row">
					<div class="col-12">
						<div>
							<div class="row mb-3 ingration-col-3">
								<div class="col-sm-3">
                      ...
                      ?>
								...
								<div class="col-sm-3">
									<div class="form-group">
										<button class="btn btn-info waves-effect orange-btn waves-light btn-integration-tools ml-0" data-toggle="modal" data-target="#cron-job-info-modal"><?= __('admin.cron_job_setting')?></button>
									</div>	
								</div>
								<div class="col-sm-3">
									<div class="form-group">
									  <button class="btn ml-0 blue-btn btn-dark waves-effect waves-light btn-integration-tools" data-toggle="modal" data-target="#perform-security-check-modal"><?= __('admin.perform_security_check')?></button>
									</div>  
								</div>
							</div>
						</div>
                ...
                <h3 class="m-t-40 text-center"><?= __('admin.no_banners_to_share_yet') ?></h3>
					...
					<div class="table-responsive b-0" data-pattern="priority-columns">
						...
						<table id="myTable" class="table table-striped table-white-space-normal">
							<thead class="blue-ng-intigration">
								<tr>
