			...
			if(isset($tool)){
				...
				if(!is_array($security_alerts)){ ?>
					<div class="alert alert-colored alert-danger">
						<b><?= "<?= __('admin.error')?> ".$security_alerts ?>:</b>
				...
				<form action="" method="get" id="form_tools">
					...
					<!-- Nav tabs -->
					<ul class="nav nav-tabs bg-color-orange">
						<li class="nav-item">
						...
						<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#conversion_api"><?= __('admin.conversion_api') ?></a></li>	
					...
					<div class="tab-content">
						<div class="tab-pane col-sm-12 active" id="home">
							...
							<div class="row">
								<div class="col-sm-7">
									...
									<?php if (isset($tool['vendor_id']) && $tool['vendor_id']!=0): ?>
										<div class="form-group">
											...
											<textarea  name="terms" class="form-control" placeholder="<?= __('admin.terms') ?>" readonly="readonly"><?= isset($tool) ? $tool['terms'] : '' ?></textarea>
										</div>
									<?php endif ?>
									...
									<div class="form-group">
										...
										<div class="category-container">
											...
											<ul class="category-selected change-color">
								...
								<?php } else { ?>
									...
									<div class="single-action-integration">
										<h6 class="mb-4 mt-0 text-monospace text-secondary">
											<?= __('admin.action_commission') ?> <?= __('admin.settings') ?></h6>
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label"><?= __('admin.number_of_action_per_commission') ?></label>
						...
						<div class="form-group">
							...
							<div class="cookies_type_input_rev m-0 mt-2 text-muted" <?= !isset($tool) || $tool['cookies_type'] == 0 ? '' : 'style="display:none"' ?>>
								<?= __('admin.default_cookies_tracker_in_days') ?>: <?= $cookie_setting['affiliate_cookie'] ?> days
							</div>
						</div>
					...
					<div class="well">
						<div class="bg-white p-3">
							...
							<div class="table-responsive">
								<table class="table banner-table background-blue-table">
									<thead>
										<tr>
					...
					<div class="row">
						<div class="col-sm-10">
							...
							<div class="col-sm-2 pull-right">
								<div class="form-group integration-page">
...
<pre class="response-view" style="background-color: #272822;color:#fff">
	...
	$response => "OK" if success 
						...
						<div class="card-footer text-right footer-integration">
