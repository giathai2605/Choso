<?php foreach ($tools as $key => $tool) { ?>
	<tr>
		...
		<td class="text-center">
			...
			<button class="btn btn-sm btn-primary btn-campaign-detail" data-toggle="tooltip" title="<?php echo __('admin.campaign_info') ?>" data-toggle="modal" data-id="<?= $tool['id']; ?>" data-target="#campaign-details-<?= $tool['id']; ?>">
		...
		<!--ACTION ICONS-->
		<td class="text-center">
			<a data-toggle="tooltip" title="<?php echo __('admin.validate_campaign') ?>" href="javascript:void(0);" class="btn btn-sm btn-info check-campaign-with-id" data-id="<?= $tool['id'] ?>">
