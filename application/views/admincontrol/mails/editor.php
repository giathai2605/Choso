								...
								<div class="tab-content">
									<?php if($allows['user'][$templates['id']]){ ?>
										<div role="tabpanel" class="tab-pane active" id="for-user">
											...
											<div class="form-group">
												<label for=""><?= __('admin.subject') ?></label>
												<textarea id="summernote-img1" type="text" class="form-control" name="text" ><?php echo $templates['text'] ?></textarea>
											</div>
										</div>
									<?php } ?>
									<?php if($allows['admin'][$templates['id']]){ ?>
										<div role="tabpanel" class="tab-pane" id="for-admin">
											...
											<div class="form-group">
												<label for=""><?= __('admin.subject') ?></label>
												<textarea id="summernote-img2" type="text" class="form-control" name="admin_text" ><?php echo $templates['admin_text'] ?></textarea>
											</div>
										</div>
									<?php } ?>
									<?php if($allows['client'][$templates['id']]){ ?>
										<div role="tabpanel" class="tab-pane" id="for-client">
											...
											<div class="form-group">
												<label for=""><?= __('admin.subject') ?></label>
												<textarea id="summernote-img3" type="text" class="form-control" name="client_text" ><?php echo $templates['client_text'] ?></textarea>
											</div>
										</div>
									<?php } ?>
								</div>
...
<script type="text/javascript">
	$( document ).ready(function() {
		...
		$('#summernote-img1').summernote();
		$('#summernote-img2').summernote();
		$('#summernote-img3').summernote();
