...
<div class="card-body">
	<fieldset class="custom-design mb-2">
		...
		<div class="row">
			...
			<div class="col-md-3 btn btn-secondary proType <?= ($product->product_type == 'video' || $product->product_type == 'videolink') ? 'btn_active' : '' ?>" data-value="video">
				<label class="radio-inline">
					<input class="invisible" type="radio" name="product_type" value="video" <?= ($product->product_type == 'video' || $product->product_type == 'videolink') ? 'checked="checked"' : '' ?> > <?= __('admin.lms_product'); ?>
				</label>
			</div>
		</div>
	</fieldset>
...
<div class="form-group">
	...
	<?php $proType1 = $product->product_type=='downloadable' ? __('admin.downloadable'): __('admin.lms_product'); ?>
...
<div class="col-sm-4 <?= ($product->product_type=='video' || $product->product_type=='videolink') ? 'd-none':''?>" id="allow_upload_file_div">
	<div class="form-group mb-0 ">
		...
		<div>
			<input name="allow_upload_file" class="btn-switch" type="checkbox" <?= (int)$product->allow_upload_file == 1 ? 'checked' : '' ?> data-toggle="toggle" data-size="normal" data-on="<?= __('admin.status_on'); ?>" data-off="<?= __('admin.status_off'); ?>" data-setting_key="allow_upload_file"  data-product_id="<?= $product->product_id ?>">
		</div>
	</div>
</div>
<div class="col-sm-4">
	<div class="form-group mb-0 ">
		...
		<div>
			<input name="on_store" class="btn-switch" type="checkbox" <?= (int)$product->on_store == 1 ? 'checked' : '' ?> data-toggle="toggle" data-size="normal" data-on="<?= __('admin.status_on'); ?>" data-off="<?= __('admin.status_off'); ?>" data-setting_key="on_store"  data-product_id="<?= $product->product_id ?>">
		</div>
	</div>
</div>
<div class="col-sm-4 <?= ($product->product_type=='video' || $product->product_type=='videolink') ? 'd-none':''?>" id="allow_shipping_div">
	<div class="form-group mb-0 " >
		...
		<div>
			<input name="allow_shipping" class="btn-switch" type="checkbox" <?= (int)$product->allow_shipping == 1 ? 'checked' : '' ?> data-toggle="toggle" data-size="normal" data-on="<?= __('admin.status_on'); ?>" data-off="<?= __('admin.status_off'); ?>" data-setting_key="allow_shipping"  data-product_id="<?= $product->product_id ?>">
		</div>
	</div>
</div>
</div>
...
<div class="form-group">
	...
	<div>
		<div class="radio status-radio update-right-part">
			<div class="row">
				<div class="col-sm-6"><label><input type="radio" name="product_status" value="0" checked=""> <span class="badge badge-warning"><?= __('admin.in_review'); ?></span></label> &nbsp;</div>
				<div class="col-sm-6"><label><input type="radio" name="product_status" value="1" <?= (int)$product->product_status == 1 ? 'checked' : '' ?> > <span class="badge badge-success"><?= __('admin.approved'); ?></span></label></div>
				<div class="col-sm-6"><label><input type="radio" name="product_status" value="2" <?= (int)$product->product_status == 2 ? 'checked' : '' ?> ><span class="badge badge-danger"><?= __('admin.denied'); ?></span></label></div>
				<div class="col-sm-6"><label><input type="radio" name="product_status" value="3" <?= (int)$product->product_status == 3 ? 'checked' : '' ?> ><span class="badge badge-yellow"><?= __('admin.ask_to_edit'); ?></span></label></div>
			</div>
		</div>
	</div>   
</div>
