...
<div class="card-header bg-blue-payment">
	<div class="card-title-white pull-left m-0"><?= (int)$review['rating_id'] == 0 ? __('admin.add_review') : __('admin.edit_review') ?></div>
</div>
<div class="card-body">
 	...
 	<div class="row">
 		<div class="col-sm-12"> 
				<div class="form-group">
					<label class="col-form-label"><?= __('admin.products') ?></label>
	    ...
	    <div class="col-sm-4">
			<div class="form-group form-image-group">
				<div>
					<label class="col-form-label"><?= __('admin.user_image') ?></label><br>
		...
		<div class="col-sm-12">
            <div class="form-group">
                <label class="control-label"><?= __('admin.review') ?></label>
                <textarea name="review_description" id="review_description" placeholder="<?= __('admin.enter_review') ?>" cols="80" class="form-control"><?= $review['rating_comments']?></textarea>
                <div class="help-block"><span class="text-danger"><?= __('store.note') ?></span> <?= __('store.html_is_not_translated') ?></div>
            </div>
            
            <div class="form-group">
                <label class="control-label"><?= __('admin.rating') ?></label>
            ...
            <div class="endtime-chooser row">
				<div class="col-sm-12">
					<div class="form-group">
						<label class="control-label d-block"><?= __('admin.choose_reviews_datetime') ?>  </label>
