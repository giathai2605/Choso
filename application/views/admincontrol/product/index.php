...
<h4 class="notification_on_pages">
   <div class="well">
      <span class="badge badge-danger"><?= __('admin.cart_product_notice') ?></span>
   </div>
</h4>
<?php } ?>
            ...
            <div class="tab-pane p-3" id="store-setting orange-store-form" role="tabpanel">
               <div role="tabpanel">
                  <ul class="nav nav-pills orange-color-bg" role="tablist" id="TabsNav">
                     ...
                     <li role="presentation" class="nav-item">
                        <a class="nav-link" href="#review_tab" aria-controls="review_tab" role="tab" data-toggle="tab"><?= __('admin.review') ?></a>
                     </li>
                  </ul>
               </div>
            </div>
                  ...
                  <div class="filter">
                     <form id="filter-form">
                        <div class="row mt-5">
                           ...
                           <div class="form-group col-2 pull-right">
                              <a id="toggle-uploader" class="btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#manageBulkProducts"><?= __('admin.manage_bulk_products') ?> </a>
                           </div>   
                        </div>
                     </form>
                  </div>
                              ...
                              <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-6 text-center">
                                          <button class="btn btn-lg btn-default btn-success text-center xml-btn export-products-xml-btn"><?= __('admin.export_products_xml') ?></button>
                                       </div>
                                       
                                       <div class="col-6 text-center">
                                          <button class="btn btn-lg btn-default btn-success text-center xml-btn export-structure-xml-btn"><?= __('admin.export_structure_xml_only') ?></button>
                                       </div>
                                    </div>
                                    <hr/>
                                       ...
                                       <div class="col">
                                          ...
                                          <div class="tab-pane p-3" id="tab_bulkprodcut_option" role="tabpanel">
                                             <div role="tabpanel">
                                                <ul class="nav nav-pills orange-color-bg" role="tablist" id="TabsNav">
                                                   <li role="presentation" class="active nav-item">
                                                      <a class="nav-link active show" href="#import_file_tab" aria-controls="import_file_tab" role="tab" data-toggle="tab"><?= __('admin.import_from_file') ?></a>
                                                   </li>
                                                   <li role="presentation" class="nav-item">
                                                      <a class="nav-link" href="#import_link_tab" aria-controls="import_link_tab" role="tab" data-toggle="tab"><?= __('admin.import_from_url') ?></a>
                                                   </li> 
                                                </ul>
                                             </div>
                                          </div>
                           ...
                           <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                 ...
                                 <div class="modal-footer">
                                    ...
                                    <button class="btn btn-lg btn-success text-center" data-dismiss="modal"><?= __('admin.cancel') ?></button>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="col-3">
                                 <div class="pull-right mb-2">
                                    <a class="btn btn-primary" href="<?= base_url('admincontrol/manage_review/')  ?>"><?= __('admin.add_new'); ?></a>
                                     <a class="btn btn-primary" href="javascript:void(0)" data-toggle="modal" data-target="#manageBulkReviews"><?= __('user.manage_bulk_reviews') ?></a>
                                 </div>
                              </div>
                           </div>
                        </form>
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <button class="btn btn-lg btn-default btn-success text-center export-reviews-xml-btn"><?= __('admin.export_reviews_xml') ?></button>
                                    </div>
                                    <div class="col-6 text-center">
                                        <button class="btn btn-lg btn-default btn-success text-center export-reviews-structure-xml-btn"><?= __('admin.export_structure_xml_only') ?></button>
                                    </div> 
                                </div>

                                <!-- tab start -->
                                  <div class="tab-pane p-3" id="tab_bulkreview_option" role="tabpanel">
                                     <div role="tabpanel">
                                        <ul class="nav nav-pills orange-color-bg" role="tablist" id="TabsNav">
                                           <li role="presentation" class="active nav-item">
                                              <a class="nav-link active show" href="#import_review_file_tab_" aria-controls="import_review_file_tab_" role="tab" data-toggle="tab" style="margin-right:10px"><?= __('admin.import_from_file') ?></a>
                                           </li>
                                           <li role="presentation" class="nav-item">
                                              <a class="nav-link" href="#import_review_link_tab" aria-controls="import_review_link_tab" role="tab" data-toggle="tab"><?= __('admin.import_from_url') ?></a>
                                           </li> 
                                        </ul>
                                     </div>
                                  </div>
                                  <div class="tab-content">
                                     <div role="tabpanel" class="tab-pane active" id="import_review_file_tab_">
                                        <form id="bulk_reviews_form" class="text-center">
                                            <div class="custom-file my-3">
                                              <input type="file" class="custom-file-input" name="file">
                                              <label class="custom-file-label" for="customFile"><?= __('admin.upload_xml_file_for_bulk_review_manage') ?></label>
                                            </div>
                                            <button id="bulk_reviews_form_btn" type="submit" class="btn btn-lg btn-default btn-success text-center"><?= __('admin.import_reviews') ?></button><br/><br/>
                                        </form>
                                     </div>
                                     <div role="tabpanel" class="tab-pane m-2" id="import_review_link_tab">
                                          <form id="bulk_reviews_form_url" class="text-center">
                                           <div class="custom-file my-3">
                                              <input name="txt_review_xmlurl" id="txt_review_xmlurl" class="textxmlurl"  type="text" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" 
                                              placeholder="<?= __('admin.enter_xml_url_for_bulk_review_manage') ?>" style="width:100%;">
                                               
                                           </div>
                                           <button id="bulk_reviews_form_url_btn" type="submit" class="btn btn-lg btn-default btn-success text-center"><?= __('admin.import_reviews') ?></button><br/><br/>
                                        </form>
                                     </div>
                                  </div>
                                   <!-- tab end -->
...
<div id="manageBulkReviewsConfirmation" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button class="btn btn-lg btn-default btn-success text-center import-reviews-confirm"><?= __('admin.confirm_product_image') ?></button>
