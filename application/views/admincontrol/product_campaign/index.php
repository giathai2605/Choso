...
<h4 class="notification_on_pages">
	<div class="well">
		<span class="badge badge-danger"><?= __('admin.sales_product_notice') ?></span>
	</div>
</h4>
<?php } ?>
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-header bg-blue-payment">
						<div class="card-title-white pull-left m-0"><?= __('admin.sales_mode_products') ?></div>
						<div class="pull-right">
								<a id="toggle-uploader" class="btn btn-primary" href="<?php echo base_url('Productsales/create') ?>"><?= __('admin.add_sale_page_product') ?>
								</a>
						</div>
					</div>
					<div class="card-body">
