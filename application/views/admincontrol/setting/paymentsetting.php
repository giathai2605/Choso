<div class="card">
    <div class="card-body orange-color-bg">
        <form class="form-horizontal" autocomplete="off" method="post" action=""  enctype="multipart/form-data" id="setting-form">
            <div class="row">
                <div class="col-sm-12">
                    <ul class="nav nav-pills nav-stacked payment-link" role="tablist" id="TabsNav">
                        <li class="nav-item">
                            <a class="nav-link active show" data-toggle="tab" href="#site-setting" role="tab">
                            <?= __('admin.site_setting') ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#site-meta" role="tab">
                            <?= __('admin.site_meta') ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#site-logo" role="tab">
                ...
                <div class="col-sm-12">
                    <div class="tab-content">
                        <div class="tab-pane p-3" id="theme" role="tabpanel">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <br>
                                    <fieldset>
                                        <legend><?= __('admin.admin_login_page') ?></legend>
                                        <div class="row d-flex theme-setting-row">
                                            <div class="col-sm-6">
                                                <label  class="control-label"><?= __('admin.admin_login_box_background_color') ?></label>
                                            </div>
                                            <div class="col-sm-4">
                                                <input class="form-control color-picker" type="color" name="theme[admin_login_box_background_color]" value="<?= $theme['admin_login_box_background_color'] != '' ? $theme['admin_login_box_background_color'] : '#7a90a8' ?>">
                                            </div>
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary default-theme-setting" value="admin_login_box_background_color"><?= __('admin.default') ?></button>
                                            </div>
                                        </div>
                                         
                                        <div class="form-group">
                                            <label class="control-label"><?= __('admin.choose_background_option') ?></label>
                                            <div>
                                                <label class="radio-inline"><input type="radio" <?= (int)$theme['admin_login_background_option'] == 0 ? 'checked' : '' ?> class="shipping_in_limited" name="theme[admin_login_background_option]" value="0"> 
                                                    <?= __('admin.set_image_as_background') ?>
                                                </label>
                                                <label class="radio-inline"><input type="radio" <?= (int)$theme['admin_login_background_option'] == 1 ? 'checked' : '' ?> class="shipping_in_limited" name="theme[admin_login_background_option]" value="1"> 
                                                    <?= __('admin.set_color_as_background') ?>
                                                </label>
                                            </div>
                                        </div>
                                         ...
                                         <div class="row d-flex theme-setting-row">
                                            <div class="col-sm-6">
                                                <label  class="control-label"><?= __('admin.admin_login_background_color') ?></label>
                                            </div>
                                            <div class="col-sm-4">
                                                <input class="form-control color-picker" type="color" name="theme[admin_login_background_color]" value="<?= $theme['admin_login_background_color'] != '' ? $theme['admin_login_background_color'] : '#5e7590' ?>">
                                            </div>
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary default-theme-setting" value="admin_login_background_color"><?= __('admin.default') ?></button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <legend><?= __('admin.admin_login_background_image') ?></legend>
                                            </div>
                                            <div class="col-sm-2">
                                                <div class="fileUpload btn btn-sm btn-primary">
                                                    <span><?= __('admin.choose_file') ?></span>
                                                    <input name="theme_admin-login-background-image" class="upload" type="file" onchange="readURLAndSetValue(this,'theme[admin-login-background-image]','#admin-login-background-image')">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <img id="admin-login-background-image" class='img-responsive_setting' src="<?= $admin_login_background_image ?>" style="width: 150px;">
                                                <?php if($theme['admin-login-background-image']) { ?>
                                                <span class="btn btn-sm btn-danger btn-delete-image" data-img_input="theme[admin-login-background-image]" data-img_ele="admin-login-background-image" data-img_placeholder="<?= base_url('assets/admin/img/bg-main.png');?>"><i class="fa fa-trash"></i></span>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <legend><?= __('admin.user_dashboard_notice') ?></legend>
                                    <div class="row">
                                        <div class="form-group col-sm">
                                            <label class="control-label"><?= __('admin.invitation_link_id') ?></label>
                                            <div>
                                                <input class="btn-switch update_all_settings" type="checkbox" <?= $userdashboard['invitation_link_id']==1 ? 'checked' : '' ?> data-toggle="toggle" data-size="normal" data-on="<?= __('admin.status_on') ?>" data-off="<?= __('admin.status_off') ?>" data-setting_key="invitation_link_id" data-setting_type="userdashboard">
                                            </div>
                                        </div>
                                ...
                                <legend><?= __('admin.display_welcome_popup') ?></legend>
                                     <div class="row">
                                        <div class="col-sm">
                                            ...
                                            <div class="form-group">
                                                <label  class="control-label"><?= __('admin.popup_title') ?></label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label"><?= __('admin.popup_video_link') ?> <span data-html="true"  data-placement="right" data-toggle="tooltip" data-container="body" title="<h6>we support all links like:</h6> <ul><li>https://www.youtube.com/watch?v=R1StjWM_LOE&feature=youtu.be</li><li>https://www.youtu.com/R1StjWM_LOE</li><li>https://www.youtube.com/embed/R1StjWM_LOE</li></ul>"></span></label>
                                            ...
                                            <div class="form-group">
                                                <label  class="control-label"><?= __('admin.popup_content') ?></label>
                        ...
                        <div class="tab-pane p-3" id="security" role="tabpanel">
                            <div class="change_admin_url mt-3">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="security[admin_url]" aria-describedby="basic-addon3" value="<?php if($security['admin_url'] == null)
                                        {echo "admin";}
                                        else
                                        {echo $security['admin_url'];} ?>">
                        ...
                        <div class="tab-pane p-3 active show" id="site-setting" role="tabpanel">
                            ...
                            <div class="form-group">
                                    <lable><?= __('admin.time_zone') ?></lable>
                                    <div class="row">
                                        <div class="col-sm">
                                            <select class="form-control" name="site[time_zone]">
                        ...
                        <div class="tab-pane p-3" id="tnc-page" role="tabpanel">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="tnc[language_id]" id="drpLanguage" onchange="return changeLanguage();">
                                    <?php 
                                    if(isset($languages))
                                    {
                                        $language_id=1;
