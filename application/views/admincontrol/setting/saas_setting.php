<?php if($saas_status){ ?>	
	<div class="card saas-settings">
		<div class="card-body">
			...
			<div class="row">
				<div class="col-sm-12">
					<ul class="nav nav-pills nav-stacked saas-bg-orange payment-link" role="tablist" id="TabsNav">
						<li class="nav-item">
						...
						<input class="btn-switch update_all_settings" type="checkbox" <?= $vendor['admin_sale_status']==1 ? 'checked' : '' ?> data-toggle="toggle" data-size="normal" data-on="<?= __('admin.status_on'); ?>" data-off="<?= __('admin.status_off'); ?>" data-setting_key="admin_sale_status" data-setting_type="vendor">
							...
							<div role="tabpanel" class="tab-pane p-3" id="vendor_deposite_setting">
								...
								<h5 class="notification_on_pages">
									<div class="mybadge text-wrap rounded badge-info mb-2 vendor-deposit-on-message 
									<?= ($vendor['depositstatus']) ? '' : 'd-none' ?>">
										<?= __('admin.vendor_deposit_on_message') ?>
									</div>
								</h5>
							
								<h5 class="notification_on_pages">
									<div class="mybadge text-wrap rounded badge-warning mb-2 vendor-deposit-off-message
										<?= ($vendor['depositstatus']) ? 'd-none' : '' ?>">
							...
							<div role="tabpanel" class="tab-pane p-3" id="vendor_permission_setting">
								<div class="form-group">
									<div class="text-wrap rounded badge-info mb-2">
...
<?php } else { ?>
	<div>
		<h4 class="notification_on_pages">
			<div class="well">
				<span class="badge badge-info"><?= __('admin.saas_module_is_off') ?></span>
