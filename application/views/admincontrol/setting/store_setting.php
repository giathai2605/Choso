							...
							<div class="tab-pane p-3" id="store-setting" role="tabpanel">
								<div role="tabpanel">
									...
									<ul class="nav nav-pills payment-link" role="tablist" id="TabsNav">
										...
										<li role="presentation" class="nav-item cart_theme_settings <?= $cart_theme_settings_display ?>">
											<a class="nav-link orange-bg-store" href="#static_pages_section" aria-controls="static_pages_section" role="tab" data-toggle="tab"><?= __('admin.static_pages_section') ?></a>
										</li>
										<li role="presentation" class="nav-item cart_theme_settings <?= $cart_theme_settings_display ?>">
											...
											<fieldset>
												...
												<div class="row">
													<div class="col-sm-6 p-4">
														...
														<img id="store-logo-image" style="width: 150px;" src="<?= $img ?>" class='img-responsive'>

														<?php if($store['logo']) { ?>
                                        <span class="btn btn-sm btn-danger btn-delete-image" data-img_input="store[logo]" data-img_ele="store-logo-image" data-img_placeholder="<?= base_url('assets/images/no_image_available.png');?>"><i class="fa fa-trash"></i></span>
                                        <?php } ?>
													</div>
													<div class="col-sm-6">
											...
											<fieldset>
												...
												<div class="row">
													<div class="col-sm-6 p-4">
														...
														<img id="store-cart-image" style="width: 50px;" src="<?= $img ?>" class='img-responsive'>
														 <?php if($store['cartimage']) { ?>
                                        <span class="btn btn-sm btn-danger btn-delete-image" data-img_input="store[cartimage]" data-img_ele="store-cart-image" data-img_placeholder="<?= base_url('assets/store/default/img/cart-icon-empty.png');?>"><i class="fa fa-trash"></i></span>
                                        <?php } ?>
													</div>
													<div class="col-sm-6">
														<input type="file" name="store_cartimage">
													</div>
												</div>
												...
												<div class="row">
				                                    <div class="col-sm-4">
				                                        <div class="form-group">
				                                            <label  class="control-label"><?= __('admin.recommended_size_is')
				                                        ?>  50x50 [px]  </label>
											...
											<fieldset>
												...
												<div class="row">
													<div class="col-sm-6 p-4">
														...
														<img id="store-favicon-image" style="width: 150px;" src="<?= $img ?>" class='img-responsive'>
														<?php if($store['favicon']) { ?>
                                        <span class="btn btn-sm btn-danger btn-delete-image" data-img_input="store[favicon]" data-img_ele="store-favicon-image" data-img_placeholder="<?= base_url('assets/images/no_image_available.png');?>"><i class="fa fa-trash"></i></span>
                                        <?php } ?>
													</div>
													<div class="col-sm-6">
