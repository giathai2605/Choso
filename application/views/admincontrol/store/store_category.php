<div class="card">
	<div class="card-header bg-blue-payment">
		<div class="card-title-white pull-left m-0"><?= __('admin.categories') ?></div>
            <div class="pull-right">
           <a id="toggle-uploader" class="btn btn-primary" href="<?php echo base_url("admincontrol/store_category_add") ?>"><?= __('admin.add_category') ?>
           </a>
        </div>
	</div>
