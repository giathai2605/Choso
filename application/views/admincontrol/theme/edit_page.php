							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<img id="page_banner_image_preview" src="<?= $page_banner_image ?>" alt="<?= __('admin.banner_image') ?>" width="100%" height="150" />
									</div>
								</div>
						...
						<div class="row">
							...
							<div class="row">
									...
									<fieldset>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													<label for="link_footer_section"><?= __('admin.parent_menu') ?></label>
													<select class="form-control" id="parent_page_id">
														<option value=""><?= __('admin.select') ?>..</option>
														<?php if (isset($dropdown_menus) && !empty($dropdown_menus)) { ?>
															<?php foreach ($dropdown_menus as $key => $value) { ?>
																<option value="<?php echo $value->page_id ?>" <?php echo ($value->page_id == $page->parent_id) ? "selected" : "" ?>><?= $value->page_name ?></option>
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="link_footer_section"><?= __('admin.footer_section_display_page_link') ?></label>
										<select class="form-control" id="link_footer_section_static">
											<option value=""><?= __('admin.select') ?>..</option>
											<option <?php echo ($page->link_footer_section == 1) ? "selected" : "" ?> value="1"><?= __('admin.menu_a') ?></option>
											<option <?php echo ($page->link_footer_section == 2) ? "selected" : "" ?> value="2"><?= __('admin.menu_b') ?></option>
											<option <?php echo ($page->link_footer_section == 3) ? "selected" : "" ?> value="3"><?= __('admin.menu_c') ?></option>
