				...
				<div class="col-sm-12">
					<ul class="nav nav-pills nav-stacked" role="tablist" id="TabsNav">
						...
						<li class="nav-item">
							...
							<a class="nav-link" href="#theme_content" data-toggle="tab" role="tab"  >
						...
						<div class="col-sm-6 multiple-pages-theme">
                            <fieldset>
                                ...
                                <div class="row d-flex theme-setting-row">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control color-picker header_menu_bg_color_responsive" type="color" name="theme[header_menu_bg_color_responsive]" value="<?= $theme['header_menu_bg_color_responsive'] != '' ? $theme['header_menu_bg_color_responsive'] : '#dd7a23' ?>">
                                    </div>
                                    <div class="col-sm-2">
                                        <button type="button" class="btn btn-primary default-front-theme-setting" value="header_menu_bg_color_responsive"><?= __('admin.default') ?></button>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
