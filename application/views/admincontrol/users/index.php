						...
						<div class="row">
							<div class="col-sm-3">
								<div class="form-group">
									<input type="search" name="name" class="form-control" placeholder=
									"<?= __('admin.name') ?>">
								</div>
							</div>
							...
							<div class="col-sm-3">
								<div class="form-group">
									<input type="search" name="email" class="form-control" placeholder=
									"<?= __('admin.email') ?>">
								</div>
							</div>
							<div class="col-sm-3">
								<div class="form-group">
									<select class="form-control select2" name="groups[]" multiple="multiple" placeholder="<?= __('admin.groups') ?>">
