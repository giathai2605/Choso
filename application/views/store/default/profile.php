						...
						<div class="checkout-form">
							...
							<div class="form-row">
								...
								<div class="form-group">
									...
									<input class="form-control" placeholder="<?= __('store.enter_your_city') ?>" name="City" id="City" value="<?php echo $userDetails['city'];?>" type="text" required>
								</div>

								<div class="form-group">
									<label><?= __('store.pincode') ?>*</label>
									<input class="form-control" placeholder="<?= __('store.enter_your_pincode') ?>" name="Zip" id="Zip" value="<?php echo $userDetails['zip'];?>" type="text" required>
								</div>
							...
							<div class="form-row">
								<div class="form-group">
									...
									<input class="form-control" name="new_password" value="" type="password" required>
								</div>
								<div class="form-group">
									<label><?= __('store.confirm_password') ?></label>
									<input class="form-control" name="c_password" value="" type="password" required>
								</div>
							</div>
