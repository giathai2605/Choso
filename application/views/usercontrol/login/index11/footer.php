<!-- Footer Nav -->
<nav class="navbar fixed-bottom navbar-light bg-transparent pad-0">
    <ul class="nav">
        <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="modal" data-target="#termOfUse" style="color: black"><?= __('front.temrs_of_use') ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="modal" data-target="#about" style="color: black"><?= __('front.about') ?></a>
        </li>
        <?php 
        ...
        <li class="nav-item <?php if(base_url(uri_string()) == base_url('/store')){ echo 'active'; } ?>">
         ...
         <?php } ?>
        <li class="nav-item">
            <a class="nav-link disabled" href="#"><?= $footer ?></a>
        </li>
    </ul>
</nav>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal"><?= __('front.close') ?></button>
            </div>
        </div>
    </div>
</div>
