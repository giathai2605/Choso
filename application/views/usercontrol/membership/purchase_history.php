                				...
                				<tr>
                                    ...
                                    <td>
                                        ...
                                        <?php $payment_details = json_decode($plan->payment_details, true); ?>
                                            ...
                                            <br><b><?= __('user.payment_status') ?>:</b> <span class="badge <?php if(in_array(strtolower($payment_details['payment_status']), array('completed','succeeded','success','complete','paid','active'))) { ?>badge-success<?php }else{ ?>badge-danger<?php } ?>"><?= ucfirst($payment_details['payment_status']) ?></span> 
                                            <?php } ?>
                                        <?php } ?>
                                    </td>
