...
<h4 class="notification_on_pages">
    <div class="well">
        <span class="badge badge-danger"><?= __('user.sales_product_notice') ?></span>
    </div>
</h4>
<?php } ?>
...
<div class="card">
    <div class="card-header">
        ...
        <div class="pull-right">
            ...
            <a style="display: none;" class="btn btn-lg btn-default btn-success" href="javascript:void(0)" data-toggle="modal" data-target="#manageBulkProducts"><?= __('user.manage_bulk_products') ?></a>
    ...
    <div class="card-body">
        ...
        <?php if ($productlist == null) {?>
            ...
            <h3 class="m-t-40 text-center text-muted"><?= __('user.no_products') ?></h3></div>
