        ...
        <div role="tabpanel">
            <ul class="nav nav-pills orange-color-bg" role="tablist" id="TabsNav">
               <li role="presentation" class="active nav-item">
                  <a class="nav-link btn-success active show" href="#products_tab" aria-controls="products_tab" role="tab" data-toggle="tab" style="margin-right:10px"><?= __('user.products') ?></a>
               </li>
               <li role="presentation" class="nav-item">
                  <a class="nav-link btn-success" href="#review_tab" aria-controls="review_tab" role="tab" data-toggle="tab"><?= __('user.review') ?></a>
               </li> 
            </ul>
        </div>
    </div>
                               ...
                               <!-- tab start -->
                                  <div class="tab-pane p-3" id="tab_bulkprodcut_option" role="tabpanel">
                                     <div role="tabpanel">
                                        <ul class="nav nav-pills orange-color-bg" role="tablist" id="TabsNav">
                                           <li role="presentation" class="active nav-item">
                                              <a class="nav-link btn-success active show" href="#import_file_tab" aria-controls="import_file_tab" role="tab" data-toggle="tab" style="margin-right:10px"><?= __('user.import_from_file') ?></a>
                                           </li>
                                           <li role="presentation" class="nav-item">
                                              <a class="nav-link btn-success" href="#import_link_tab" aria-controls="import_link_tab" role="tab" data-toggle="tab"><?= __('user.import_from_url') ?></a>
                                           </li> 
                                        </ul>
                                     </div>
                                  </div>
                                     ...
                                     <div role="tabpanel" class="tab-pane" id="import_link_tab">
                                          <form id="bulk_products_form_url" class="text-center">
                                           <div class="custom-file my-3">
                                              ...
                                              placeholder="<?= __('user.enter_xml_url_for_bulk_product_manage') ?>" style="width:100%;">
                                               
                                           </div>
                                           <button id="bulk_products_form_url_btn" type="submit" class="btn btn-lg btn-default btn-success text-center"><?= __('user.import_products') ?></button><br/><br/>
                                        </form>
                                     </div>
                                  </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="pull-right">
                        ...
                        <a class="btn btn-lg btn-default btn-success" href="javascript:void(0)" data-toggle="modal" data-target="#manageBulkReviews"><?= __('user.manage_bulk_reviews') ?></a>
                    </div>
                                ...
                                <!-- tab start -->
                                  <div class="tab-pane p-3" id="tab_bulkreview_option" role="tabpanel">
                                     <div role="tabpanel">
                                        <ul class="nav nav-pills orange-color-bg" role="tablist" id="TabsNav">
                                           <li role="presentation" class="active nav-item">
                                              <a class="nav-link btn-success active show" href="#import_review_file_tab_" aria-controls="import_review_file_tab_" role="tab" data-toggle="tab" style="margin-right:10px"><?= __('user.import_from_file') ?></a>
                                           </li>
                                           <li role="presentation" class="nav-item">
                                              <a class="nav-link btn-success" href="#import_review_link_tab" aria-controls="import_review_link_tab" role="tab" data-toggle="tab"><?= __('user.import_from_url') ?></a>
                                           </li> 
                                        </ul>
                                     </div>
                                  </div>
                                  <div class="tab-content">
                                     <div role="tabpanel" class="tab-pane active" id="import_review_file_tab_">
                                        <form id="bulk_reviews_form" class="text-center">
                                            <div class="custom-file my-3">
                                              <input type="file" class="custom-file-input" name="file">
                                              <label class="custom-file-label" for="customFile"><?= __('user.upload_xml_file_for_bulk_review_manage') ?></label>
                                            </div>
                                            <button id="bulk_reviews_form_btn" type="submit" class="btn btn-lg btn-default btn-success text-center"><?= __('user.import_reviews') ?></button><br/><br/>
                                        </form>
                                     </div>
                                     <div role="tabpanel" class="tab-pane m-2" id="import_review_link_tab">
                                          <form id="bulk_reviews_form_url" class="text-center">
                                           <div class="custom-file my-3">
                                              ...
                                              placeholder="<?= __('user.enter_xml_url_for_bulk_review_manage') ?>" style="width:100%;">
                                               
                                           </div>
                                           <button id="bulk_reviews_form_url_btn" type="submit" class="btn btn-lg btn-default btn-success text-center"><?= __('user.import_reviews') ?></button><br/><br/>
                                        </form>
                                     </div>
                                  </div>
                                   <!-- tab end -->
