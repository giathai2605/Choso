...
<div class="container-fluid pt-4">
	...
	<span class="badge badge-info"><?= __('user.registration_approval_pending') ?></span>
	</h2>
	<div class="jumbotron">
...
<div class="container-fluid pt-4">
	<h2 class="notification_on_pages">
	<span class="badge badge-success"><?= __('user.registration_approval_verify_success') ?></span>
	</h2>
	<div class="jumbotron">
	  <h1 class="display-4 mb-4"><?= __('user.hello') ?>, <?= $this->session->userdata['user']['firstname']; ?> <?= $this->session->userdata['user']['lastname']; ?>!</h1>
